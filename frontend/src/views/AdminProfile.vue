          ...
          <div class="card-body p-4">
            <div class="profile-grid">
              <div class="profile-item">
                ...
                <div class="content">
                  <h6 class="item-label">Username</h6>
              ...
              <div class="profile-item">
                ...
                <div class="content">
                  ...
                  <p class="item-value">{{ user.email }}</p>
                </div>
              </div>
              <div class="profile-item">
                <div class="icon-wrapper">
                ...
                <div class="content">
                  <h6 class="item-label">Role</h6>
                  <p class="item-value">{{ user.role }}</p>
                </div>
              </div>
              <div class="profile-item">
                <div class="icon-wrapper">
                ...
                <div class="content">
                  <h6 class="item-label">Approved</h6>
                  <p class="item-value">{{ user.approved ? 'Yes' : 'No' }}</p>
                </div>
              </div>
            </div>
          ...
          <div class="card-body p-4">
            <div class="edit-form">
              ...
              <div class="form-group">
                ...
                <select v-model="user.approved" class="form-control">
...
export default {
  setup() {
    ...
    const user = ref({ username: '', email: '', role: '', approved: false });
    const isEditing = ref(false);
    let originalUser = ref(null);

    const fetchUserData = () => {
      axios.get(`/api/profile/user/${userId.value}`)
        .then(response => {
    ...
    const saveChanges = () => {
      axios.put(`/api/profile/user/${userId.value}`, user.value)
        .then(() => {
    ...
    return { user, isEditing, saveChanges, cancelEditing };
  }
};
</script>
